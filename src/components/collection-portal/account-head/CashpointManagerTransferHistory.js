...
class CashpointManagerTransferHistory extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            "data": [],
    ...
    prepareDownload(source) {
        ...
        for (var j = 0; j < currentRecords.length; j++) {
            ...
            dataArray[4] = currentRecords[j].cashpoint.userId;
            dataArray[5] = currentRecords[j].cashpoint.name;
            dataArray[6] = currentRecords[j].cashpointDSEWallet.walletId;

            dataArray[7] = currentRecords[j].transferAmount;
            dataArray[8] = currentRecords[j].apiCallStatus;

            dataArray[9] = currentRecords[j].id;
    ...
    componentDidMount() {
        ...
        try {
            fetch(gwUrl + "collection-service/endpoint/wallet/cpmanagertransfer/accountId",
                {
                    "method": "POST",
                    "headers": {
    ...
    getComponentDesign() {
        ...
        let componentDesign = <div className="home">
            <div className="row">
                <div className="col">
                    <p className="page-title">Manager Transactions</p>
                </div>
            </div>
...
export default withRouter(CashpointManagerTransferHistory);