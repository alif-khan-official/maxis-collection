...
class BusinessHouseTopUp extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            "data": [],
    ...
    componentDidMount() {
        ...
        try {
            fetch(gwUrl + "collection-service/endpoint/wallet/bhtopup/accountId",
                {
                    "method": "POST",
                    "headers": {
    ...
    getComponentDesign() {
        ...
        let componentDesign = <div className="home">
            <div className="row">
                <div className="col">
                    <p className="page-title">Business House Credit Transfers</p>
                </div>
            </div>
...
export default withRouter(BusinessHouseTopUp);