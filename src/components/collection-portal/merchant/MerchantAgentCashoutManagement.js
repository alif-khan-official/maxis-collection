...
class MerchantAgentCashoutManagement extends React.Component {
	constructor(props) {
		super(props);
		this.state = {
			"data": [],
	...
	prepareDownload(source) {
		...
		for (var j = 0; j < currentRecords.length; j++) {
			...
			dataArray[1] = currentRecords[j].agentId;
			dataArray[2] = currentRecords[j].agentName;
			dataArray[3] = currentRecords[j].cashoutMerchantRequestAmount;
			dataArray[4] = currentRecords[j].cashoutRequestStatus;
...
export default withRouter(MerchantAgentCashoutManagement);